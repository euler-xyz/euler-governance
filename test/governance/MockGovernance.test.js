...
const Stub = artifacts.require('MockGovernance');
...
// batch items tx hex data is encoded batch items array and address array, e.g., const encodedBatchTxData = exec.interface.encodeFunctionData('batchDispatch', [batch, []]);

contract('MockGovernance', function (accounts) {

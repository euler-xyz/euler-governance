...
contract('GovernorTimelockControl', function (accounts) {
  ...
  beforeEach(async function () {
    ...
    this.token = await Token.new(tokenName, tokenSymbol, tokenSupply);
    this.timelock = await Timelock.new(3600, [], []);
    this.mock = await Governor.new(name, this.token.address, 4, 16, this.timelock.address, 4, web3.utils.toWei('10'));
